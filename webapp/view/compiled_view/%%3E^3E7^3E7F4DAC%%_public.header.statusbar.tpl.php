<?php /* Smarty version 2.6.26, created on 2010-08-19 14:38:17
         compiled from _public.header.statusbar.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'relative_datetime', '_public.header.statusbar.tpl', 47, false),array('modifier', 'capitalize', '_public.header.statusbar.tpl', 48, false),array('modifier', 'urlencode', '_public.header.statusbar.tpl', 54, false),)), $this); ?>
<?php echo '
...
">Private Dashboard</a></li>
        <?php else: ?>
          <?php if ($this->_tpl_vars['instance']): ?><li class="round-tl round-bl"><a href="<?php echo $this->_tpl_vars['site_root_path']; ?>
